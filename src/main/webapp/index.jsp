  ...
  <body>
    ...
    >
      ...
      <!--  aside.jsp -->
		...
		<jsp:include page = "/inc/asideHome.jsp" ></jsp:include>
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      <th class="px-4 py-3">게시자</th>
                      <th class="px-4 py-3">공지내용</th>
                      <th class="px-4 py-3">공지날짜</th>
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-3">멤버등급</th>
                      <th class="px-4 py-3">가입날짜</th>
